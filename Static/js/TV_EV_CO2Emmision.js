...
function parameterFilter(row) {
   ...
   function createChart() {
    ...
    mean: d3.mean(v, function(d) { return parseFloat(d["CO2Emissions(g/m)"]); })
    }; })
    ...
    let layout = {
    title: "CO2 Emission per Car Type",
    plot_bgcolor:"white",
    paper_bgcolor:"black",
    font:{color:"white"},
    barmode:"group",
    ...
    yaxis: {
    title: "AverageCO2 Emission (Gram/Mile)"
    },
    legend: {
    font: {
    color: "white"
    ...
    Plotly.newPlot("plot4", traceData, layout);
    });
    });
   };
